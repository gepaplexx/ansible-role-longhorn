...
- Check out the [existing issues](https://github.com/gepaplexx/ansible-role-longhorn/issues) & see if we [accept contributions](#types-of-contributions-memo) for your type of issue.
- Before you make your changes, check to see if an [issue exists](https://github.com/gepaplexx/ansible-role-longhorn/issues/) already for the change you want to make.
...
Once your PR is merged, you will be proudly listed as a contributor in the [contributor chart](https://github.com/gepaplexx/ansible-role-longhorn/graphs/contributors).
...
You can contribute in several ways. This repo is a place to discuss and collaborate on the ansible role gepaplexx.longhorn! Our small, but mighty :muscle: gepaplexx team is maintaining this repo. To preserve our bandwidth, off topic conversations will be closed.

### :mega: Discussions
Discussions are where we have conversations.

If you'd like help troubleshooting a PR you're working on, have a great new idea, or want to share something amazing you've learned in our docs, join us in [discussions](https://github.com/gepaplexx/ansible-role-longhorn/discussions).
